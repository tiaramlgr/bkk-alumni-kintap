...
@section('title', 'Tambah Master Jurusan')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-slate-900">Tambah Jurusan Baru</h2>
            <p class="text-sm text-slate-500 mt-1">Isi formulir data master kompetensi keahlian</p>
        </div>

        <form method="POST" action="{{ route('admin.jurusan.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="kode_jurusan" value="{{ old('kode_jurusan') }}" required 
                       class="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:outline-none focus:border-blue-500 @error('kode_jurusan') border-rose-500 @enderror" placeholder="Contoh: TKJ, TKR">
            ...
            <div>
                ...
                <input type="text" name="nama_kompetensi" value="{{ old('nama_kompetensi') }}" required 
                       class="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:outline-none focus:border-blue-500 @error('nama_kompetensi') border-rose-500 @enderror" placeholder="Contoh: Teknik Komputer dan Jaringan">
            ...
            <div>
                ...
                <input type="text" name="nama_program" value="{{ old('nama_program') }}" required 
                       class="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:outline-none focus:border-blue-500 @error('nama_program') border-rose-500 @enderror" placeholder="Contoh: Teknik Komputer dan Informatika">
            ...
            <div>
                ...
                <input type="text" name="nama_bidang" value="{{ old('nama_bidang') }}" required 
                       class="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:outline-none focus:border-blue-500 @error('nama_bidang') border-rose-500 @enderror" placeholder="Contoh: Teknologi Informasi dan Komunikasi">
